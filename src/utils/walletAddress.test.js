...
it('validates valid LVE address', () => {
    expect(validateWalletAddress('Ld6fzgV5KgD59ZosrapETHVsMhBUrzgFUg', 'LVE')).toEqual(true);
  });

it('invalidates invalid LVE address', () => {
    expect(validateWalletAddress('random address', 'LVE')).toEqual(false);
  });
